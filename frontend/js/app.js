function login(){
  ...
  xhr.open("POST", "http://127.0.0.1:8080/annonetwork/signin.php", false);
...
function signup(){
  ...
  var xhr = new XMLHttpRequest({mozSystem:true});
  xhr.open("POST", "http://127.0.0.1:8080/annonetwork/register.php", false);
...
function postQue(){
 var que_json = {
  ...
  var xhr = new XMLHttpRequest({mozSystem:true});
  xhr.open("POST", "http://127.0.0.1:8080/annonetwork/insert.php", false);
